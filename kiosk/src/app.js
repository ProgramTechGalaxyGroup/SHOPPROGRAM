  ...
  function KioskView(props) {
    ...
    return html`
      <div className="kiosk-wrapper">
            ...
            ${displayProducts.map(function(p) {
              ...
              return html`
                <div key=${p.id} className="k-prod">
                  ...
                  <div style=${{ fontSize: "1.15rem", fontWeight: 700, marginBottom: 12 }}>${parsed[0]}</div>
        ...
        ${viewState === "main" && cartTotalItems > 0 ? html`
          <div className="k-footer" style=${{ opacity: 1, pointerEvents: "auto" }}>
