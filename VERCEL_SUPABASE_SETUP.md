...
- Frontend hiện tại là static web app: `index.html`, `app.js`, `styles.css`
...
- [supabase/schema.sql](/Users/charlotte/Desktop/NGÂN HÀ/CTY TechGalaxy Group/SHOPPROGRAM/supabase/schema.sql)
- [supabase/seed.sql](/Users/charlotte/Desktop/NGÂN HÀ/CTY TechGalaxy Group/SHOPPROGRAM/supabase/seed.sql)
- [supabase/seed.json](/Users/charlotte/Desktop/NGÂN HÀ/CTY TechGalaxy Group/SHOPPROGRAM/supabase/seed.json)
- [supabase/manifest.json](/Users/charlotte/Desktop/NGÂN HÀ/CTY TechGalaxy Group/SHOPPROGRAM/supabase/manifest.json)
...
- Add-ons
- Components
- Toàn bộ master product list từ `db_dump.json`
...
Nếu bạn cập nhật lại `db_dump.json` hoặc nguồn sản phẩm, chạy:
